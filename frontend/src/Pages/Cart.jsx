...
const Cart = () => {
  ...
  if (!user) {
    return (
      <div className="min-h-screen w-full flex justify-center items-center bg-gray-400">
        ...
        <Link
          to="/signup"
          className="flex justify-center pl-2 text-blue-500 cursor-pinter"
        >
          Sign Up
        </Link>
      </div>
  ...
  return (
    <div className="flex min-h-screen w-full justify-center flex-col gap-2 bg-gradient-to-br from-pink-300 via-white to-purple-300">
      <div className="flex flex-col items-center p-5 w-[80%] sm:w-[90%] bg-white m-4 rounded-2xl shadow-xl border border-pink-200">
                ...
                if (
                  ...
                  return (
                    <tr key={item.productId._id}>
                      <td colSpan="5">Missing data for product</td>
                    </tr>
                  );
                }
      ...
      <div className="flex items-center justify-center p-2">
        <Link
          to="/checkout"
          className="flex justify-center items-center bg-pink-500 p-5 w-[300px] rounded-xl hover:bg-pink-600 text-white text-xl capitalize shadow-md transition-transform transform hover:scale-105"
        >
          Check Out
        </Link>
      </div>
